...
function myLowerBodyFunctionTwo() {
  document.getElementById("lower-body").innerHTML = "1. Lower body";
}
...
function myUpperBodyFunctionTwo(){
  document.getElementById('upper-body').innerHTML = "2. Upper body"
}
...
function myCoreFunctionTwo(){
  document.getElementById('core').innerHTML= "3. Core"
}
...
function myCardioFunctionTwo(){
  document.getElementById('cardio').innerHTML="4. Cardio"
}
